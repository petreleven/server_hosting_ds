...
CREATE TABLE IF NOT EXISTS servers (id uuid PRIMARY KEY DEFAULT uuid_generate_v4(), subscription_id uuid, status VARCHAR(50), ip_address VARCHAR(45), ports TEXT, docker_container_id VARCHAR(100), created_at TIMESTAMPTZ DEFAULT NOW(), config JSONB,
